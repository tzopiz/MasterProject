...
from visualize_detector import *
import matplotlib.pyplot as plt

# Load volume
volume = load_dicom_volume(Path('data/dataset/study_0001'))
...
manual = load_manual_annotation(Path('data/dataset'), 'study_0001')
...
plot_prediction(volume, coords_left, coords_right, crop_size=200, 
