...
def plot_segmentation_overlay(
    ...
    if gt_mask is not None:
        ...
        axes[2].legend(handles=[green_patch, red_patch, blue_patch], loc="upper right", fontsize=8)
...
def plot_side_by_side(
    ...
    axes[1, 1].legend(handles=[green_patch, red_patch, blue_patch], loc="upper right", fontsize=10)
...
def plot_metrics_history(train_metrics: dict, val_metrics: dict, save_path: Optional[Path] = None):
    """
...
def plot_confusion_matrix(confusion_matrix: dict, save_path: Optional[Path] = None):
    """
...
if __name__ == "__main__":
    ...
    plot_segmentation_overlay(
        image, pred_mask, gt_mask, title="Test Overlay", save_path="test_overlay.png"
    )
