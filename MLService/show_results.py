...
checkpoint_path = sys.argv[1] if len(sys.argv) > 1 else 'experiments/detector_20251124_013727/best_model.pth'
...
if history:
    ...
    for i in range(start_idx, len(val_mae_hist)):
        ...
        print(f"  {indicator} Epoch {i+1:3d}: Train={train_mae[i]:6.2f} px | Val={val_mae_hist[i]:6.2f} px")
else:
