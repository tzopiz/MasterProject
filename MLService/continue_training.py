...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--checkpoint", type=str, required=True, help="Path to checkpoint to resume from"
    )
    parser.add_argument(
        "--total_epochs", type=int, default=150, help="Total number of epochs to train to"
    )
    parser.add_argument(
        "--lr", type=float, default=1e-5, help="Learning rate for continued training"
    )
    parser.add_argument("--patience", type=int, default=20, help="Patience for LR scheduler")
