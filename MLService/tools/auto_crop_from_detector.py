...
def main():
    ...
    p.add_argument(
        "--split-json",
        default="data/detector_split.json",
        help="Use all studies from split JSON (train+val+test). Ignored if --studies is given.",
    )
    p.add_argument("--studies", nargs="*", help="Explicit list of study IDs to process")
