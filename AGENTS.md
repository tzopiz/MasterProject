...
- В **git** не попадают личные и сгенерированные файлы (см. `.gitignore`: веса, загрузки, часть локальных каталогов `docs/`, `Nir/`, `examples/`, `scripts/presentation/`, `plan.md` и т.д.).
